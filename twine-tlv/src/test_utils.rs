...
use twine_macros::{ConstantTlv, Tlv};

use crate::{
    traits::{GetTlvLength, TlvLength, TryEncodeTlv},
    write_tlv, DecodeTlvUnchecked, DecodeTlvValueUnchecked, PutTlvLength, TlvConstantMetadata,
    TlvMetadata, TlvType, TryEncodeTlvValue, TwineTlvError,
};

pub(crate) const TEST_TLV_DATA_TYPE_ZERO: [u8; 3] = [0x00, 0x01, 0xAA];

#[derive(Clone, Copy, Debug, Eq, PartialEq, ConstantTlv)]
